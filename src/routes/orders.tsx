...
export function Order() {
    ...
    return (
        <div className="flex flex-col gap-6 pb-5 justify-start h-screen overflow-x-hidden bg-background">
            ...
            <header className="fixed top-0 left-0 w-full flex items-center justify-center bg-background z-10 pt-5 pb-2">
                <div className="flex items-center justify-start w-1/3 pl-3">
